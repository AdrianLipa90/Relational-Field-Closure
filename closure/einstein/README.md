...
11. complete physical RFC/IDT current and matter stress-energy binding — **OPEN**;
12. full action-level Einstein + dynamic-`Lambda0` promotion and unified-limit audit — **OPEN**.
...
RF-N1C now supplies the exact weak-field normalization chain
...
The source, double-copy and horizon routes are tied by the RF-N1C coupling-holonomy syzygy. Physical promotion now depends on the already explicit current/matter binding, Yang–Mills/BCJ normalization, double-copy scale binding and cross-system universality gates.

**Current status:** `GEOMETRIC_SPINE_PRESENT / AB_MAXWELL_SOURCE_BRIDGE_PRESENT / RFN1C_EINSTEIN_NORMALIZATION_TRANSFER_PRESENT / PHYSICAL_COUPLING_PROMOTION_OPEN`.
