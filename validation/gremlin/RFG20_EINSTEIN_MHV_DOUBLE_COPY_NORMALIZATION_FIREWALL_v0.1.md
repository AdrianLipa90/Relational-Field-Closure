...
RFG20 consumes RFG9, RFG15, RFG16 and RFG19. It audits the overall normalization of the project four-point double copy against an independent Einstein four-graviton tree amplitude. No numerator is changed or fitted to the gravity result. RFG21 and RFG22 consume this normalization downstream.
...
\[
\boxed{A^{project}_{1234}=\frac{n_s}{s}-\frac{n_u}{u}=-2i A^{PT}_{1234}.}
\]
...
\[
\boxed{\mathcal M_4^{project}=-i\left(\frac{\kappa_g}{4}\right)^2\sum_i\frac{n_i\tilde n_i}{D_i}=-\frac{i\kappa_E}{4}\mathcal C_{DC}^{project}.}
\]
...
\[
\boxed{\mathcal M_{--++}^{project}=-\frac{i\kappa_E}{4}\left(-4\frac{s^3}{tu}\right)=i\kappa_E\frac{s^3}{tu}=\mathcal M_{4,\mathrm{MHV}}^{Ein}.}
\]
...
\[
\boxed{\mathcal M^{old}/\mathcal M^{Ein}=-4.}
\]
...
The core factorization results of RFG21/RFG22 are preserved; only the external coupling coefficient consumes this normalization firewall.
...
RFG21 project pole core factorization           PASS DOWNSTREAM
RFG22 project KLT core                          PASS DOWNSTREAM
RFG23 five-point BCJ/soft reference             HIGHER-POINT DOWNSTREAM
